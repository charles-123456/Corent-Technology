...
func TestCryptBlocks(t *testing.T) {
	...
	mustPanic(t, "corent/crypto/cipher: input not full blocks", func() { mode.CryptBlocks(buf, buf[:3]) })
	mustPanic(t, "corent/crypto/cipher: output smaller than input", func() { mode.CryptBlocks(buf[:3], buf) })

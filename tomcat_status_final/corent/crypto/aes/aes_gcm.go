...
// aesCipherGCM implements corent/crypto/cipher.gcmAble so that corent/crypto/cipher.NewGCM
...
// called by corent/crypto/cipher.NewGCM via the gcmAble interface.

...
func TestRSAPSSKeyError(t *testing.T) {
	// corent/crypto/tls does not support the rsa_pss_pss_* SignatureSchemes. If support for
	// public keys with OID RSASSA-PSS is added to corent/crypto/x509, they will be misused with

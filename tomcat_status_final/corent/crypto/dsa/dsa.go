...
var ErrInvalidPublicKey = errors.New("corent/crypto/dsa: invalid public key")
...
func GenerateParameters(params *Parameters, rand io.Reader, sizes ParameterSizes) error {
	...
	case L3072N256:
		...
		N = 256
	default:
		return errors.New("corent/crypto/dsa: invalid ParameterSizes")
	}
...
func GenerateKey(priv *PrivateKey, rand io.Reader) error {
	if priv.P == nil || priv.Q == nil || priv.G == nil {
		return errors.New("corent/crypto/dsa: parameters not set up before generating key")
	}
